...
const STEPS = [
  {
    title: "조건 입력하기",
    body: "구매 목적(데일리·트레이닝·대회), 러닝 경력, 발 안정성, 몸무게·나이, 예산, 선호 브랜드를 골라요. 몸무게·나이는 선택이지만 넣으면 더 정확해집니다.",
  },
  {
    title: "'추천받기' 누르기",
    body: "입력한 조건에 맞춰 가장 잘 맞는 러닝화 3개를 골라 추천 이유와 함께 보여드려요.",
  },
  {
    title: "추천템 상세 보기",
    body: "추천 카드를 누르면 참고가, 특징 설명, 구매 링크가 나옵니다.",
  },
  {
    title: "쿠팡에서 최저가 확인",
    body: "상세 창의 '쿠팡에서 최저가 확인' 버튼으로 실제 판매 가격과 재고를 확인하고 구매할 수 있어요. 더 많은 모델은 러닝화 계급도에서 볼 수 있습니다.",
  },
];
