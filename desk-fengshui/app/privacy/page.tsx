...
export const metadata: Metadata = {
  title: "개인정보처리방침 · 책상풍수",
  description:
    "책상풍수 서비스의 개인정보 수집·이용 및 쿠키·광고에 관한 안내입니다.",
};
    ...
    <div className="min-h-screen bg-white font-sans text-zinc-900 antialiased">
      <main className="mx-auto w-full max-w-[640px] px-5 py-10 sm:px-6">
        ...
        <div className="mt-8 space-y-8 text-sm leading-relaxed text-zinc-700">
          <section>
            <p>
              책상풍수(이하 &ldquo;서비스&rdquo;)는 이용자의 개인정보를 중요하게
          ...
          <section>
            ...
            <ul className="list-disc space-y-1.5 pl-5">
              <li>
                <strong>업로드 이미지</strong> — 이용자가 책상 풍수 분석을 위해
                직접 올린 사진입니다. 오직 AI 분석 결과를 제공하기 위한 목적으로만
                사용됩니다.
              </li>
              <li>
          ...
          <section>
            ...
            <p>
              업로드한 사진은 분석을 위해 AI 처리 업체인 <strong>OpenAI</strong>의
              API로 전송됩니다. 서비스는 분석 결과를 생성한 뒤 해당 이미지를 자체
              서버에 저장하지 않으며, 별도의 데이터베이스에 보관하지 않습니다.
              OpenAI의 데이터 처리 방식은{" "}
              <a
