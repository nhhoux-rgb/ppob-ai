...
export const metadata: Metadata = {
  ...
  description:
    "등기번호 대량 일괄조회, 접수증 OCR 인식, 배송상태·반송 확인, 엑셀 저장에 관해 자주 묻는 질문을 모았습니다.",
};
...
const QA = [
  ...
  {
    q: "결과를 엑셀로 저장할 수 있나요?",
    a: "‘엑셀 저장’을 누르면 엑셀에서 바로 열리는 파일로 내려받아집니다. 한글도 깨지지 않으니 발송대장으로 관리하세요.",
  },
  {
    q: "입력한 등기번호나 수취인 정보가 저장되나요?",
    a: "조회를 위해 등기번호가 우체국 API로 전송되고, 접수증 이미지는 등기번호 인식을 위해 AI로 전송됩니다. 서비스는 조회 결과를 자체 데이터베이스에 보관하지 않으며, 결과는 이용자 브라우저에서 표로 표시되고 엑셀 파일로 내려받아집니다.",
  },
];
