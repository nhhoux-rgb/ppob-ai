...
export const metadata: Metadata = {
  ...
  title: "이용 방법 · 등기우편 대량조회",
  description:
    "접수증 사진을 올리거나 등기번호를 붙여넣어 우체국 배송상태를 한 번에 조회하고 엑셀로 저장하는 방법을 안내합니다.",
};
...
const STEPS = [
  {
    ...
    desc: "접수증(영수증) 사진을 올리면 등기번호를 자동으로 읽어옵니다. 또는 등기번호를 한 줄에 하나씩 붙여넣거나, 파일(CSV·TXT)을 불러와도 됩니다.",
  },
  {
    n: 2,
    title: "인식된 번호 확인",
  ...
  },
  {
    n: 4,
    title: "표 확인 · 엑셀로 저장",
    desc: "상태별로 필터링해 반송·미수령만 골라 볼 수 있습니다. ‘엑셀 저장’을 누르면 엑셀에서 바로 여는 발송대장 파일로 내려받아집니다.",
  },
];
